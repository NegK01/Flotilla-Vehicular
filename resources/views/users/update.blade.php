                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-info card-outline mb-4">
                                ...
                                <!--end::Header-->
                                <!--begin::Form-->
                                <form action="{{route('users.update', $users['id']) }}" method="post" class="needs-validation" novalidate>
                                    @csrf
                                    @method('PUT')
                                    <!--begin::Body-->
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div>
                                                ...
                                                <select class="form-select" name="role_id" id="role">
                                                    ...
                                                    <option value="2" {{ $users['role_id'] == 2 ? 'selected' : '' }}>Operador</option>
                                                    <option value="3" {{ $users['role_id'] == 3 ? 'selected' : '' }}>Driver</option>
                                                </select>
                                            </div>
                                            <!--begin::Col-->
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <label for="validationCustom05" class="form-label">Confirme contraseña</label>
                                                <input type="text" class="form-control" id="validationCustom05"
