            ...
            <div class="col-lg-6 m-3">
                <div class="card card-outline card-primary h-100 mb-3 ">
                    ...
                    <div class="card-body ">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <a href="{{ route('vehicles.index') }}" class="btn btn-primary w-100 py-2">
            ...
            <div class="app-content">
                <div class="container-fluid">
                    <div class="row text-center">
                        ...
                        <h3>Solicitudes de vehículos</h3>
                        ...
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $request['driver']['full_name'] ?? 'Sin chofer' }}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('vehicles-request.aprove', $request['id']) }}" method="post" style="display:inline;">
                                            @csrf
                                            @method('PATCH')
                                        ...
                                        <form action="{{ route('vehicles-request.reject', $request['id']) }}" method="post" style="display:inline;">
                                            @csrf
                                            @method('PATCH')
